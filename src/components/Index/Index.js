    ...
    <React.Fragment>
                ...
                <div class="slider-img one-img">
                  <div class="container">
                    <div class="slider-info ">
                      <h5>
                        Pick The Best Toy For <br />
                        Your Kid
                      </h5>
                      <div class="bottom-info">
                        <p>
                          Lorem ipsum dolor sit amet, consectetuer adipiscing
                          elit.Aenean commodo ligula eget dolorL orem ipsum
                          dolor sit amet eget dolor
                        </p>
                      </div>
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
        <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
          <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
            New Arrivals
          </h3>
          <div class="slid-img">
            <ul id="flexiselDemo1">
                    ...
                    <div class="least-w3layouts-text-gap">
                      <div class="row">
                        ...
                        <div class="mt-3 news-agile-text">
                          ...
                          />
                          <p class="mt-3">
                            <span class="fas fa-quote-left"></span> velit
                            ...
                            posuere <span class="fas fa-quote-right"></span>
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="email-sub-agile">
            <form action="#" method="post">
              <div class="form-group sub-info-mail">
                <input
                  type="email"
                  class="form-control email-sub-agile"
                  placeholder="Email"
                />
              </div>
              <div class="text-center">
                <button type="submit" class="btn subscrib-btnn">
                  Subscribe
                </button>
              </div>
            </form>
